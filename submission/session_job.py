...
GEOCODING_API_KEY = "94B3DF22CBF7CD60CF5BA1CD984F21FB"
...
by_session = (
    ...
    .count()
    .select(hash(col("user_id"), col("ip"), col("session_window.start"), col("session_window.end")).cast("string").alias("session_id"),
        col("user_id"),
