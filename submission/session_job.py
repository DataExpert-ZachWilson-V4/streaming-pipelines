...
GEOCODING_API_KEY = '2601:600:9000:cba0:8dcd:cb4e:8598:7394'
...
by_country = tumbling_window_df.groupBy(window(col("timestamp"), "5 minute"),
                                        col("geodata.country"),
                                        col("geodata.city"),
                                        col("geodata.state")
                                        ) \
    ...
    .select(
        ...
        col("event_count"),
        col("user_id"),
        col("session_start_date"),
        col("country"),
        col("state"),
        col("city"),
        col("os"),
        col("browser"),
        col("logged_in_user_status")
    )
