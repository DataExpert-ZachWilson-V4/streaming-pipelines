...
from pyspark.sql.functions import col, lit, window, from_json, udf, when, concat_ws
...
GEOCODING_API_KEY = '3ACF0C258753816C0C2DD2CD8C772B4C'
...
by_session = tumbling_window_df.groupBy(window(col("timestamp"), "5 minute"),
    ...
    .select(
        ...
        col("user_id").isNotNull().alias("Logged_in_out_flag")
    )
