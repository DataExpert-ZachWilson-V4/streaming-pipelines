...
GEOCODING_API_KEY = 'DEA96C0EF77D73251E163A2739AE8DFC'
...
def main():
    ...
    try:
        ...
        # Process the Kafka stream and aggregate events into sessions
        ...
        query.awaitTermination(timeout = 60*60)  # Timeout after 1 hour to prevent indefinite running
