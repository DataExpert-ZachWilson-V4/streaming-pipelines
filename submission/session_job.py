...
#Read on Pub-Sub from google article, Kafka architecture, spark streaming lectures
...
# stop the job after 10 minutes
# PLEASE DO NOT REMOVE TIMEOUT
query.awaitTermination(timeout=60*10)